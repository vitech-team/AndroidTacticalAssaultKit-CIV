...
import com.atakmap.android.atak_sk42support.heatmap.GLSimpleHeatMapLayer;
import com.atakmap.android.atak_sk42support.heatmap.SimpleHeatMapLayer;
...
import com.atakmap.android.atak_sk42support.image.MapScreenshotExample;
import com.atakmap.android.atak_sk42support.layers.LayerDownloadExample;
import com.atakmap.android.atak_sk42support.menu.MenuFactory;
import com.atakmap.android.atak_sk42support.view.ViewOverlayExample;
...
import com.atakmap.android.atak_sk42support.recyclerview.RecyclerViewDropDown;
import com.atakmap.android.atak_sk42support.speechtotext.SpeechBloodHound;
import com.atakmap.android.atak_sk42support.speechtotext.SpeechBrightness;
import com.atakmap.android.atak_sk42support.speechtotext.SpeechDetailOpener;
import com.atakmap.android.atak_sk42support.speechtotext.SpeechItemRemover;
import com.atakmap.android.atak_sk42support.speechtotext.SpeechLinker;
import com.atakmap.android.atak_sk42support.speechtotext.SpeechNavigator;
import com.atakmap.android.atak_sk42support.speechtotext.SpeechNineLine;
import com.atakmap.android.atak_sk42support.speechtotext.SpeechPointDropper;
import com.atakmap.android.atak_sk42support.speechtotext.SpeechToActivity;
...
import com.atakmap.android.atak_sk42support.samplelayer.*;
 ...
 */
public class ATAK_SK42SupportDropDownReceiver extends DropDownReceiver implements
        OnStateListener, SensorEventListener {

    private final NotificationManager nm;

    public static final String TAG = "ATAK_SK42SupportDropDownReceiver";

    public static final String SHOW_ATAK_SK42Support = "com.atakmap.android.atak_sk42support.SHOW_ATAK_SK42Support";
    public static final String CHAT_ATAK_SK42Support = "com.atakmap.android.atak_sk42support.CHAT_ATAK_SK42Support";
    public static final String SEND_ATAK_SK42Support = "com.atakmap.android.atak_sk42support.SEND_ATAK_SK42Support";
    public static final String LAYER_DELETE = "com.atakmap.android.atak_sk42support.LAYER_DELETE";
    public static final String LAYER_VISIBILITY = "com.atakmap.android.atak_sk42support.LAYER_VISIBILITY";
    private final View helloView;

    private final Context pluginContext;
    private final Contact helloContact;
    private RouteEventListener routeEventListener = null;
    private final ATAK_SK42SupportMapOverlay mapOverlay;
    ...
    public ATAK_SK42SupportDropDownReceiver(final MapView mapView,
                                            final Context context, ATAK_SK42SupportMapOverlay overlay) {
        super(mapView);
        ...
        AtakBroadcast.DocumentedIntentFilter dif = new AtakBroadcast.DocumentedIntentFilter(
                "com.atakmap.android.atak_sk42support.FAKE_PHONE_CALL");
        ...
        helloView = PluginLayoutInflater.inflate(pluginContext,
                R.layout.atak_sk42support_layout, null);
        // Add "ATAK_SK42Support" contact
        this.helloContact = addPluginContact(pluginContext.getString(
                R.string.atak_sk42support));
        ...
        svgMarker.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                marker.setTitle("ATAK_SK42Support");
            ...
            public void onClick(View v) {
                ...
                if (mi == null) {
                    ...
                    m.persist(mapView.getMapEventDispatcher(), null,
                            ATAK_SK42SupportDropDownReceiver.class);
                } else {
        ...
        pluginNotification.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent startServiceIntent = new Intent(
                        "com.atakmap.android.atak_sk42support.notification.NotificationService");
                startServiceIntent
                        .setPackage("com.atakmap.android.atak_sk42support.plugin");
                ...
                if (val) {
                    ...
                    AtakBroadcast.getInstance().registerReceiver(
                            ...
                            new AtakBroadcast.DocumentedIntentFilter(
                                    "com.atakmap.android.atak_sk42support.InspectionMapItemSelectionTool.Finished"));
                    Bundle extras = new Bundle();
                    ToolManagerBroadcastReceiver.getInstance().startTool(
                            "com.atakmap.android.atak_sk42support.InspectionMapItemSelectionTool",
                            extras);
        ...
        cameraLauncher.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClassName("com.atakmap.android.atak_sk42support.plugin",
                        "com.atakmap.android.atak_sk42support.CameraActivity");
            ...
            public void onClick(View v) {
                ...
                if (!b) {
                    ...
                    sensorManager.registerListener(
                            ATAK_SK42SupportDropDownReceiver.this,
        ...
        speechToText.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent();
                intent.setClassName("com.atakmap.android.atak_sk42support.plugin",
                        "com.atakmap.android.atak_sk42support.SpeechToTextActivity");
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        speechToActivity.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent();
                intent.setClassName("com.atakmap.android.atak_sk42support.plugin",
                        "com.atakmap.android.atak_sk42support.speechtotext.SpeechToActivity");
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                intent.putExtra("EXTRA_MESSAGE", "");
                parentActivity.startActivityForResult(intent, 0);
        ...
        addLayer.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                File f = FileSystemUtils.getItem("tools/atak_sk42support/logo.png");
                    ...
                    if ((exampleMultiLayers == null)
                        ...
                        for (int index = 0; index < 3; index++) {
                            ...
                            ExampleMultiLayer exampleMultiLayer = new ExampleMultiLayer(
                                    pluginContext,
                                    String.format(
                                            "ATAK_SK42Support Test Multi Layer %4d",
                                            altitude),
    ...
    synchronized public void runSim() {
        ...
        if (item != null) {
            ...
            data.putString("mockLocationSource", "ATAK_SK42Support Plugin");
    ...
    public void disposeImpl() {
        // Remove ATAK_SK42Support contact
        ...
        SensorManager sensorManager = (SensorManager) getMapView().getContext()
                .getSystemService(Context.SENSOR_SERVICE);
        sensorManager.unregisterListener(ATAK_SK42SupportDropDownReceiver.this);
        TextContainer.getTopInstance().closePrompt();
    ...
    @Override
    public void onReceive(Context context, Intent intent) {
        Log.d(TAG, "showing atak_sk42support drop down");
        ...
        switch (action) {
            case SHOW_ATAK_SK42Support:
                ...
                setAssociationKey("ATAK_SK42SupportPreference");
            ...
            // Chat message sent to ATAK_SK42Support contact
            case CHAT_ATAK_SK42Support:
            ...
            // Sending CoT to ATAK_SK42Support contact
            case SEND_ATAK_SK42Support:
                // Map item UID
    ...
    public Contact addPluginContact(String name) {
        ...
        ATAK_SK42SupportContactHandler contactHandler = new ATAK_SK42SupportContactHandler(
                pluginContext);
        ...
        contact.addConnector(new PluginConnector(CHAT_ATAK_SK42Support));

        // Add IP connector so the contact shows up when sending CoT or files
        contact.addConnector(new IpConnector(SEND_ATAK_SK42Support));
