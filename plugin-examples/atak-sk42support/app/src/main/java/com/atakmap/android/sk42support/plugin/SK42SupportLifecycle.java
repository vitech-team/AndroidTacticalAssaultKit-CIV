...
package com.atakmap.android.sk42support.plugin;
...
import com.atakmap.android.sk42support.SK42SupportMapComponent;
...
public class SK42SupportLifecycle implements Lifecycle {

    private final Context pluginContext;
    private final Collection<MapComponent> overlays;
    private MapView mapView;

    private final static String TAG = "SK42SupportLifecycle";

    public SK42SupportLifecycle(Context ctx) {
    ...
    public void onCreate(final Activity arg0,
        ...
        SK42SupportLifecycle.this.overlays
                .add(new SK42SupportMapComponent());

        // create components
        Iterator<MapComponent> iter = SK42SupportLifecycle.this.overlays
                .iterator();
        MapComponent c;
        while (iter.hasNext()) {
            c = iter.next();
            try {
                c.onCreate(SK42SupportLifecycle.this.pluginContext,
                        arg0.getIntent(),
                        SK42SupportLifecycle.this.mapView);
            } catch (Exception e) {
                Log.w(TAG,
