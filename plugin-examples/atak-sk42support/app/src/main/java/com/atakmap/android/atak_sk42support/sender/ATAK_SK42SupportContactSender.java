...
package com.atakmap.android.atak_sk42support.sender;
 ...
 */
public class ATAK_SK42SupportContactSender extends TAKContactSender {

    private final Context _plugin;

    public ATAK_SK42SupportContactSender(MapView mapView, Context plugin) {
        super(mapView);
        _plugin = plugin;
    }
