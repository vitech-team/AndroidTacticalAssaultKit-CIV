package com.atakmap.android.sk42support.sk42;
 ...
 *
 */
public class CoordDialogViewUpgraded extends LinearLayout implements
    ...
    public CoordDialogViewUpgraded(final Context context) {
        super(context);
        this.context = context;
    }

    public CoordDialogViewUpgraded(final Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }
    ...
    private boolean _pullFromDTED() {
        ...
        if (point != null) {
            ...
            if (altHAE.get().isAltitudeValid()) {
                ...
                Toast.makeText(
                        getContext(),
                        mainAppContext.getResources().getString(
                                com.atakmap.app.R.string.goto_input_tip1),
    ...
    private GeoPointMetaData _getMGRS() {
        try {
            ...
            Log.e(TAG, mainAppContext.getString(com.atakmap.app.R.string.goto_input_tip2), e);
            Toast.makeText(getContext(),
                    mainAppContext.getString(com.atakmap.app.R.string.goto_input_tip2),
                    Toast.LENGTH_LONG).show();
        }
        return null;
    }
    ...
    private GeoPointMetaData _getDD() {
        try {
            ...
            Log.e(TAG, mainAppContext.getString(com.atakmap.app.R.string.goto_input_tip3), e);
            Toast.makeText(getContext(),
                    mainAppContext.getString(com.atakmap.app.R.string.goto_input_tip3),
                    Toast.LENGTH_LONG).show();
            return null;
        }
    }
    ...
    private GeoPointMetaData _getAddress() {
        try {
            ...
            Log.e(TAG, mainAppContext.getString(com.atakmap.app.R.string.goto_input_tip4), e);
            Toast.makeText(getContext(),
                    mainAppContext.getString(com.atakmap.app.R.string.goto_input_tip4),
                    Toast.LENGTH_LONG).show();
            return null;
        }
    }
    ...
    private GeoPointMetaData _getDM() {
        try {
            ...
            Log.e(TAG, mainAppContext.getString(com.atakmap.app.R.string.goto_input_tip5), e);
            Toast.makeText(getContext(),
                    mainAppContext.getString(com.atakmap.app.R.string.goto_input_tip5),
                    Toast.LENGTH_LONG).show();
            return null;
        }
    }
    ...
    private GeoPointMetaData _getDMS() {
        try {
            ...
            Log.e(TAG, mainAppContext.getString(com.atakmap.app.R.string.goto_input_tip6), e);
            Toast.makeText(getContext(),
                    mainAppContext.getString(com.atakmap.app.R.string.goto_input_tip6),
                    Toast.LENGTH_LONG).show();
            return null;
        }
    }
    ...
    protected void onFinishInflate() {
        ...
        if (!isInEditMode()) { // The editor can't handle tabs apparently;
            ...
            TabSpec sk42Tab = _host.newTabSpec("SK42");
            sk42Tab.setIndicator("SK42");
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.swap)
            ...
            if (isNetworkAvailable()) {
                ...
                Toast.makeText(
                        getContext(),
                        mainAppContext.getString(com.atakmap.app.R.string.goto_input_tip8),
        ...
        // Address tab
            ...
            if (isADDRtabDisabled) {
                Toast.makeText(
                        getContext(),
                        mainAppContext.getString(com.atakmap.app.R.string.goto_input_tip7),
                        Toast.LENGTH_SHORT).show();
                if (_currFormat == CoordinateFormat.ADDRESS)
        ...
        if (locationAddress.equals("")) {
            if (_currPoint != null) {
                final ProgressDialog pd = ProgressDialog.show(context,
                        mainAppContext.getString(com.atakmap.app.R.string.goto_dialog1),
                        mainAppContext.getString(com.atakmap.app.R.string.goto_dialog2), true,
                        false);
                ...
                Toast.makeText(getContext(),
                        mainAppContext.getString(com.atakmap.app.R.string.goto_input_tip9),
                        Toast.LENGTH_SHORT).show();
            }
            return;
        }
    ...
    public void setMainAppContext(Context context) {
