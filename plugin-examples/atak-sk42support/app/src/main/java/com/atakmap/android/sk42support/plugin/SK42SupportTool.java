...
import com.atakmap.android.sk42support.SK42SupportDropDownReceiver;
...
public class SK42SupportTool extends Tool implements ToolDescriptor {

    private final Context context;

    public SK42SupportTool(Context context) {
    ...
    public void onActivate(Activity arg0, MapView arg1, ViewGroup arg2,
        ...
        Intent i = new Intent(
                SK42SupportDropDownReceiver.SHOW_PLUGIN);
