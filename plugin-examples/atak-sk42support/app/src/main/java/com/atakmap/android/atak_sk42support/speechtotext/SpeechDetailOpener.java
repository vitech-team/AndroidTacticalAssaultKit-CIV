 ...
 * Needs to be its own class because you can't access AtakBroadcast inside ATAK_SK42SupportDropDownReceiver
...
public class SpeechDetailOpener {
     ...
     * @param view - view from the ATAK_SK42SupportDropDownReceiver. Needed to get the self marker. And to get the mapGroups
     */
