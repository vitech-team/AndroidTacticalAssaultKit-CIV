...
public class ATAK_SK42SupportWidget extends AbstractWidgetMapComponent implements
    ...
    public static final String TAG = "ATAK_SK42SupportWidget";
    ...
    private final BroadcastReceiver wacky = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (widget == null) {
                ...
                widget.addOnClickListener(ATAK_SK42SupportWidget.this);
                widget.addOnPressListener(ATAK_SK42SupportWidget.this);
                widget.addOnUnpressListener(ATAK_SK42SupportWidget.this);
                widget.addOnMoveListener(ATAK_SK42SupportWidget.this);
