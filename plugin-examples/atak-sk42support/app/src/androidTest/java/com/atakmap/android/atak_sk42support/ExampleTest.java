...
public class ExampleTest extends ATAKTestClass {
    private final ATAK_SK42SupportRobot ATAK_SK42SupportRobot = new ATAK_SK42SupportRobot();

    @BeforeClass
    public static void setupPlugin() throws Exception {
        ATAK_SK42SupportRobot.installPlugin();
        fixClassLoaderForClass(ExampleTest.class,
                "com.atakmap.android.atak_sk42support.plugin");
    }
